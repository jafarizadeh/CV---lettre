...
\section{Éducation}
    ...
    \textit {Note: Des images de la traduction Française de ce document sont incluses dans les pages suivantes.}
        ...
        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{2-1-1.jpg}
            \footnotesize
            \href{https://drive.google.com/drive/folders/1exnTtHlIYL6iuwfPhsyiyPdnZts1jeJA}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}

        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{2-1-2.jpg}
            \footnotesize
            \href{https://drive.google.com/drive/folders/1exnTtHlIYL6iuwfPhsyiyPdnZts1jeJA}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}

        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{2-1-3.jpg}
            \footnotesize
             \href{https://drive.google.com/drive/folders/1exnTtHlIYL6iuwfPhsyiyPdnZts1jeJA}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    % 2.2 Renewable energy engineering
    ...
    \newpage
        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{2-2-1.jpg}
            \footnotesize
             \href{https://drive.google.com/drive/folders/1xNH0ipNTy5i6ssvk_6DFSIzNKQmrmhkz}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
        
        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{2-2-2.jpg}
            \small\vspace{0.5em} % Optional: Adjust the space between the image and the text
            \href{https://drive.google.com/drive/folders/1xNH0ipNTy5i6ssvk_6DFSIzNKQmrmhkz}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}

        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{2-2-3.jpg}
            \footnotesize
             \href{https://drive.google.com/drive/folders/1xNH0ipNTy5i6ssvk_6DFSIzNKQmrmhkz}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
...
\section{Expérience Professionnelle}
    ...
    \newpage
        ...
        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{3-1.jpg}
            \footnotesize
             \href{https://drive.google.com/drive/folders/1TSQ8G6qWy8pfHR51fcCKIuTJA7X_VjSc}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \newpage
        ...
        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{3-2.jpg}
            \footnotesize
             \href{https://drive.google.com/drive/folders/1WPX670swruvInZ5R6UUo2SW2J3Mbt3Ga}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \newpage
        ...
        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{3-3.jpg}
            \footnotesize
             \href{https://drive.google.com/drive/folders/1iYLhIBDRrnoymRKt1509NGEtZyM53voH}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
...
% =========================================================
    ...
    \section{Contributions Académiques}
    % 4.1 Co-auteur
    ...
    \newpage
        ...
        \begin{center}
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{4-1.jpg}
            \footnotesize
             \href{https://drive.google.com/drive/folders/13i-zZIWv1lmISCPmEJHnfeIAvknWaYK5}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
...
\section{Certificats de Fin de Cours}
    ...
    \newline
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/19STm99n4UCAVd1w_vIAP9ge3o30a1IPD}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \newline
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/file/d/1OMlK6WWfGZl3nI6oK6-WQFp45_KqLrSV/view?usp=drive_link}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \newline
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \newline
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/1Ejf2Iho7D7d3gjdxzdIPlC891teT5Y64}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \subsection{Initiation à Wireshark pour l'analyse de paquets sous linux}
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/1GMKB9b49qlV5s0hoI33D0GN9RJuVWRKb}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/1sI3blreDdlAkkdojoXv8rrFxuYUS7mph}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/10L4MkO-1yZMetGUBvoCLePqvXsIH2j-i}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
...
\section{Certificats d'Accomplissement}
    ...
    \newline
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/15JOlGLGelqoL970VUMM5A-OPsuT671qb}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    ...
    \newline
        \begin{center}
            %\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{}
            \footnotesize
             \href{https://drive.google.com/drive/folders/1sS1dgmC4hxQd_HP08KK3kuVjB8BldlF-}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    \newpage
...
\section{Compétitions Scientifiques}
    ...
    \newpage
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/1QJr8YZ-r2Zvn38sRTdmfIfaxAYCKjfNi}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    \newpage
...
\section{Certificat de Reconnaissance}
    ...
    \newpage
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/1uKRDhC47KFOIxnGW9rlsWEyyyz1cDx7R}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    \newpage
    ...
    \newpage
        ...
        \begin{center}
            ...
            \footnotesize
             \href{https://drive.google.com/drive/folders/1cAS8Ct20hDelABtksh8-BrusRfGzcSa3}{Veuillez cliquer ici pour accéder au document dans Google Drive}.
        \end{center}
    \newpage
